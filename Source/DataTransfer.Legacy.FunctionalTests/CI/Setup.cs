...
namespace Relativity.DataTransfer.Legacy.FunctionalTests.CI
{
	...
	public class Setup
	{
		...
		public void SetupTests()
		{
			...
			var additionalSettings = new Dictionary<string, string> { ["PerformRelativityVersionCheck"] = "false" };
			var configurationRoot = new ConfigurationBuilder().AddNUnitParameters()
