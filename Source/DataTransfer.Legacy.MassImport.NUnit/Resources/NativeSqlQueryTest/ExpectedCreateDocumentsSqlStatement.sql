...
DROP TABLE IF EXISTS [Resource].[RELNATPARENTACENSTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038], [Resource].[RELNATNEWANCESTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038];

SELECT P.ArtifactID, PARENT.ParentArtifactID
INTO [Resource].[RELNATNEWANCESTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038]
FROM [Resource].[RELNATTMPPART_DCD09DF6-A4C7-4DF0-B963-0050C7809038] P
...
ALTER TABLE [Resource].[RELNATNEWANCESTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038] ADD PRIMARY KEY(ArtifactID);

SELECT N.ArtifactID, A.AncestorArtifactID
INTO [Resource].[RELNATPARENTACENSTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038]
FROM [Resource].[RELNATNEWANCESTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038] N
JOIN [EDDSDBO].ArtifactAncestry A ON A.ArtifactID = N.ParentArtifactID;

ALTER TABLE [Resource].[RELNATPARENTACENSTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038] ADD PRIMARY KEY(ArtifactID,AncestorArtifactID);

INSERT INTO [EDDSDBO].ArtifactAncestry(ArtifactID, AncestorArtifactID)
SELECT ArtifactID, ParentArtifactID FROM [Resource].[RELNATNEWANCESTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038]
UNION ALL
SELECT ArtifactID, AncestorArtifactID FROM [Resource].[RELNATPARENTACENSTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038];

DROP TABLE [Resource].[RELNATPARENTACENSTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038], [Resource].[RELNATNEWANCESTORS_DCD09DF6-A4C7-4DF0-B963-0050C7809038];
