...
CASE
	WHEN EXISTS
		...
		WHERE
			[ObjectType].[DescriptorArtifactTypeID] = 10
...
WHERE
	...
	AND N.[kCura_Import_Status] & 1048576 = 0;/*Prevent creating associated objects of type document*/
UPDATE N
SET
	[kCura_Import_Status] = [kCura_Import_Status] + 2097152
FROM [Resource].[RELNATTMP_DCD09DF6-A4C7-4DF0-B963-0050C7809038] N
WHERE
	...
	AND [kCura_Import_Status] & 2097152 = 0;
