...
IF (SELECT COALESCE([OverlayMergeValues],0) FROM [Field] WHERE [ArtifactID] = 2) = 0
BEGIN
	DELETE FROM
		[ZCodeArtifact_102]
	...
	WHERE
		EXISTS(
			...
			WHERE
				ArtifactID=[ZCodeArtifact_102].[AssociatedArtifactID]
				AND
				[RELNATTMP_974a2b26_d665_4f42_8b3b_31949b335a01].[kCura_Import_Status] = 0
		)

	INSERT INTO [ZCodeArtifact_102] (
	...
	INNER JOIN [Resource].[RELNATTMP_974a2b26_d665_4f42_8b3b_31949b335a01] ON
		...
		[RELNATTMP_974a2b26_d665_4f42_8b3b_31949b335a01].[kCura_Import_Status] = 0
	WHERE
		[RELNATTMPCOD_974a2b26_d665_4f42_8b3b_31949b335a01].[CodeTypeID] = 102
END
ELSE
BEGIN
	INSERT INTO [ZCodeArtifact_102] (
	...
	INNER JOIN [Resource].[RELNATTMP_974a2b26_d665_4f42_8b3b_31949b335a01] ON
		...
		AND
		[RELNATTMP_974a2b26_d665_4f42_8b3b_31949b335a01].[kCura_Import_Status] = 0
	LEFT JOIN [ZCodeArtifact_102] AS [ExistingChoices] ON
