...
namespace DataTransfer.Legacy.MassImport.RelEyeTelemetry
{
	public static class TelemetryConstants
	{
		...
		public static class AttributeNames
		{
			...
			/// <summary>
			/// [integer] [0,] count of items processed in job that was successful
			/// </summary>
			public const string JobSuccessfulCount = "job.successful_count";
		...
		public class EventName
		{
			...
			public const string DataGridRecordsProcessed = "data_grid_records_processed";
		}
	}
}
