...
namespace Relativity.DataTransfer.Legacy.Services.Helpers
{
	internal class ProductionImportCoordinator : IImportCoordinator
	{
		...
		{
			return massImportManager.RunProductionImageImport(serviceContext, _settings.Map<ImageLoadInfo>(), _productionArtifactID, _inRepository, _settings.BulkFileSharePath);
		}
	}
}